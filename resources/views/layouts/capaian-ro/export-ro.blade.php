<table>
    <tr>
        ...
        <td style="word-wrap:break-word;vertical-align: center;width: 100px;border-top:2px solid black;border-right:2px solid black">Program</td>
...
@foreach ($capaian as $k => $v)
    <tr>
        ...
        <td style="border:2px solid black;border-left:2px solid black">{{ $v->program }}</td>
...
@endforeach
    <tr>
        <td style="border:2px solid black;border-left:2px solid black" colspan="8">TOTAL</td>
